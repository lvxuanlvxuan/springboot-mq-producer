 ...
 */
@RestController
@RequestMapping("controller-fanout")
public class FanoutModelController {

    @Autowired
    private FanoutModelService fanoutModelService;

    @PostMapping("/send")
    public ResponseEntity send(@RequestBody OrderVO vo) {
        fanoutModelService.send(vo, FanoutModelConstance.FANOUT_MODEL_EXCHANGE);
